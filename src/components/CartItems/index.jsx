...
const EmptyCartSVG = () => (
	<svg width="400" height="160" viewBox="0 0 300 120" xmlns="http://www.w3.org/2000/svg" opacity="0.6">
		{/* Texto "SEU CARRINHO" */}
		<text x="15" y="45" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" fill="#999">
			SEU CARRINHO
		</text>
		
		{/* Texto "ESTÁ VAZIO" */}
		<text x="15" y="75" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" fill="#999">
			ESTÁ VAZIO
		</text>
		...
		<g transform="translate(220, 25)">
			...
			<g transform="translate(44, 27)">
				<line x1="-6" y1="-6" x2="6" y2="6" stroke="#e74c3c" strokeWidth="2.5" strokeLinecap="round"/>
				<line x1="6" y1="-6" x2="-6" y2="6" stroke="#e74c3c" strokeWidth="2.5" strokeLinecap="round"/>
			</g>
		</g>
	</svg>
